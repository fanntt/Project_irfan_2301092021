...
import fanntt_14062024.controller.PeminjamanController;
/**
 *
 * 
 */
public class FormPeminjamanArrayOriginal extends javax.swing.JFrame {

    /**
     * 
     */
    PeminjamanController controller;
    public FormPeminjamanArrayOriginal() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormPeminjamanArrayOriginal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormPeminjamanArrayOriginal().setVisible(true);
            }
        });
    }
